...
import { createnewConversation, createnewGroupConversation, getallconversationmessages, getAllConversations, getConversation, getConversationInformation, getConversationMediaInformation, getUsers } from "../controllers/conversation.controller.js";
const router=Router()
...
router.route('/mediainformation/:conversationId').get(verifyJWT,getConversationMediaInformation);
